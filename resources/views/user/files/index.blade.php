            ...
            <div class="card-body">
                ...
                <form action="#" id="files-table-search" method="post">
                    <div class="input-group bg-container justify-content-between p-3 mb-4">
                        ...
                        <select class="form-select mb-2 mb-xxl-0" name="type" aria-label="File type">
                            <option value="" selected>{{ __('lang.file_type') }}</option>
                            @foreach ($fileTypes as $key => $value)
                                <option value="{{ $value }}">{{ $value }}</option>  
                            @endforeach
                        </select>
                        <select class="form-select mb-2 mb-md-0" name="sort" aria-label="Sort">
                        ...
                        <button class="btn btn-color-1" type="submit">{{ __('lang.filter') }}</button>
                        <button class="btn btn-color-2 mt-2 mt-xxl-0" id="reset-files" type="button">{{ __('lang.reset') }}</button>
                    </div>
                </form>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">{{ __('lang.file_type') }}</th>
