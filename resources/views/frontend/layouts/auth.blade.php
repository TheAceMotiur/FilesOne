...
<html 
    ...
    <body class="auth-page{{ setting('loader') == 1 ? ' overflow-hidden pe-none' : '' }}">
        <main class="auth-main d-flex justify-content-center align-items-center position-relative min-vh-100">
            @yield('content')
            @if (setting('loader') == 1)
