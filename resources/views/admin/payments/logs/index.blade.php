        ...
        <div class="card">
            <div class="card-body">
                ...
                <div 
                    ...
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/payments/logs') }}"
                    data-columns="Date,User,Plan,Duration,Gateway,Status,Action" 
...
<form method="POST" action="#" class="verify-payment-modal-form">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text m-0">{{ __('lang.verify_payment') }}</p>
                    @csrf
                </div>
...
<form method="POST" action="{{ LaravelLocalization::localizeUrl('/admin/payments/logs/delete') }}" class="delete-modal-form">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4>{{ __('lang.modal_question') }}</h4>
                    <p class="modal-text m-0">{{ __('lang.reject_payment') }}</p>
                    @csrf
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-color-4" data-bs-dismiss="modal">{{ __('lang.cancel') }}</button>
