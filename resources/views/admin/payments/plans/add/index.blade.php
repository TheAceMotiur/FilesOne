...
<form 
    method="POST" 
    action="{{ LaravelLocalization::localizeUrl('/admin/payments/plans/add') }}">
    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="{{ old('name') }}" autocomplete="off">
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                ...
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4 mb-sm-0 mb-lg-0 mb-md-4">
                                    ...
                                    <input type="number" name="price-monthly" class="form-control" id="price-monthly" value="{{ old('price-monthly') }}" autocomplete="off">
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6">
                                    <label for="price-yearly" class="form-label">{{ __('lang.yearly_price') }}</label>
                                    <input type="number" name="price-yearly" class="form-control" id="price-yearly" value="{{ old('price-yearly') }}" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                    ...
                                    <input type="number" name="disk" class="form-control" id="disk" value="{{ old('disk') }}" autocomplete="off">
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                    ...
                                    <select class="form-select" name="auto-deletion" id="auto-deletion" aria-label="Auto deletion">
                                        <option value="0"{{ old('auto-deletion') == 0 ? ' selected' : '' }}>{{ __('lang.disable') }}</option>
                                        <option value="1"{{ old('auto-deletion') == 1 ? ' selected' : '' }}>1 {{ __('lang.day') }}</option>
                                        <option value="7"{{ old('auto-deletion') == 7 ? ' selected' : '' }}>7 {{ __('lang.days') }}</option>
                                        <option value="30"{{ old('auto-deletion') == 30 ? ' selected' : '' }}>30 {{ __('lang.days') }}</option>
                                        <option value="90"{{ old('auto-deletion') == 90 ? ' selected' : '' }}>90 {{ __('lang.days') }}</option>
                                        <option value="180"{{ old('auto-deletion') == 180 ? ' selected' : '' }}>180 {{ __('lang.days') }}</option>
                                        <option value="360"{{ old('auto-deletion') == 360 ? ' selected' : '' }}>360 {{ __('lang.days') }}</option>
                                    </select>
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4 mb-sm-0 mb-lg-0 mb-md-4">
                                    <label for="api" class="form-label">API</label>
                                    <select class="form-select" name="api" id="api" aria-label="Api">
                                        <option value="1"{{ old('api') == 1 ? ' selected' : '' }}>{{ __('lang.enable') }}</option>
                                        <option value="0"{{ old('api') == 0 ? ' selected' : '' }}>{{ __('lang.disable') }}</option>
                                    </select>
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6">
                                    ...
                                    <select class="form-select" name="countdown" id="countdown" aria-label="Skip countdown">
                                        <option value="1"{{ old('countdown') == 1 ? ' selected' : '' }}>{{ __('lang.enable') }}</option>
                                        <option value="0"{{ old('countdown') == 0 ? ' selected' : '' }}>{{ __('lang.disable') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
