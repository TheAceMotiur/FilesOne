    ...
    <div>
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <div 
                    class="plans-table table-init" 
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/payments/plans') }}" 
                    data-columns="Name,Monthly Price,Yearly Price,Status,Action" 
                    data-search="true"
                    data-buttons="plan"></div>
            </div>
        </div>
    </div>
</div>
<form 
    method="POST" 
    action="{{ LaravelLocalization::localizeUrl('/admin/payments/plans/delete') }}" 
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">{{ __('lang.modal_text') }}</p>
                    <p class="modal-text fw-bold m-0">{{ __('lang.modal_plan_delete') }}</p>
                    @csrf
                </div>
