    ...
    <div>
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <div 
                    class="users-table table-init" 
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/users') }}" 
                    data-columns="Name,Email,Status,Action" 
                    data-search="true"></div>
            </div>
        </div>
    </div>
</div>
<form method="POST" action="{{ LaravelLocalization::localizeUrl('/admin/users/delete') }}" class="delete-modal-form">
