        ...
        <div class="card">
            <div class="card-body">
                ...
                <div 
                    ...
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/affiliate/payout-rates') }}" 
                    data-columns="Country Name,Country Code,Rate,Action" 
                    data-search="true" 
                    data-buttons="payoutRates"></div>
            </div>
        </div>
    </div>
</div>
<form method="POST" action="{{ LaravelLocalization::localizeUrl('/admin/affiliate/payout-rates/delete') }}" class="delete-modal-form">
