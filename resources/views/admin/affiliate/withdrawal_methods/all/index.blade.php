    ...
    <div>
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <div 
                    class="payout-rates-table table-init" 
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/affiliate/withdrawal-methods') }}" 
                    data-columns="Method Name,Min Amount,Status,Action" 
                    data-search="true" 
                    data-buttons="withdrawalMethods"></div>
            </div>
        </div>
    </div>
</div>
<form method="POST" action="{{ LaravelLocalization::localizeUrl('/admin/affiliate/withdrawal-methods/delete') }}" class="delete-modal-form">
