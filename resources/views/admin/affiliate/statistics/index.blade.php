        ...
        <div class="card">
            <div class="card-body">
                ...
                <div 
                    ...
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/affiliate/statistics') }}" 
...
<form method="POST" action="{{ LaravelLocalization::localizeUrl('/admin/affiliate/statistics/delete') }}" class="delete-modal-form">
