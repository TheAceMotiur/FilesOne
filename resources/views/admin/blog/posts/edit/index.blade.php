...
<form 
    method="POST" 
    action="{{ LaravelLocalization::localizeUrl("/admin/blog/posts/edit/{$post['id']}") }}" 
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" value="{{ $post['title'] }}" autocomplete="off">
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-4 mb-4">
                                    ...
                                    @if ($post['featured_photo'])
                                        <div class="img-container d-flex p-3 mt-4">
                                            <div class="covered" style="background: url({{ img('blog', $post['featured_photo']) }});"></div>
                                        </div>
                                    @endif
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-4 mb-4">
                                ...
                                <div class="col-sm-6 col-md-12 col-lg-4 mb-4">
                                    ...
                                    <select class="form-select" name="status" id="status" aria-label="Status">
                                        <option value="1"{{ $post['status'] == 1 ? ' selected' : '' }}>{{ __('lang.public') }}</option>
                                        <option value="0"{{ $post['status'] == 0 ? ' selected' : '' }}>{{ __('lang.private') }}</option>
                                    </select>
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4 mb-sm-0 mb-lg-0 mb-md-4">
                                    ...
                                    @if ($seo['og_image'])
                                        <div class="img-container d-flex p-3 mt-4">
                                            <div class="covered" style="background: url({{ img('blog', $seo['og_image']) }});"></div>
                                        </div>
                                    @endif
                                </div>
