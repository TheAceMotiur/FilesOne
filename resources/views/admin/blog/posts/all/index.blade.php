    ...
    <div>
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <div 
                    class="posts-table table-init" 
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/blog/posts') }}" 
                    data-columns="Date,Title,Category,Status,Action" 
                    data-search="true"
                    data-buttons="post"></div>
            </div>
        </div>
    </div>
</div>
<form 
    method="POST" 
    action="{{ LaravelLocalization::localizeUrl('/admin/blog/posts/delete') }}" 
