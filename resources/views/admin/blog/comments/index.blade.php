    ...
    <div>
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <div 
                class="comments-table table-init"
                data-url="{{ LaravelLocalization::localizeUrl('/admin/blog/comments') }}" 
                data-columns="Date,User,Comment,Action" 
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text m-0">{{ __('lang.verify_comment') }}</p>
                    @csrf
                </div>
...
<form 
    method="POST" 
    action="{{ LaravelLocalization::localizeUrl('/admin/blog/comments/delete') }}" 
