...
<form 
    method="POST" 
    action="{{ LaravelLocalization::localizeUrl("/admin/pages/custom/edit/{$page['id']}") }}" 
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                    ...
                                    <input type="text" name="content[header][upper_title]" class="form-control" id="upper-title" value="{{ $content['header']['upper_title'] ?? '' }}" autocomplete="off">
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                            ...
                            <div class="row">
                                <div>
                                    <textarea 
                                        ...
                                        class="editor editor-init">{!! $content['content'] ?? '' !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
