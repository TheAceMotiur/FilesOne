    ...
    <div>
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <div 
                    class="pages-table table-init" 
                    data-url="{{ LaravelLocalization::localizeUrl('/admin/pages/custom') }}" 
                    data-columns="Name,Slug,Status,Action" 
                    data-search="true"
                    data-buttons="page"></div>
            </div>
        </div>
    </div>
</div>
<form 
    method="POST" 
    action="{{ LaravelLocalization::localizeUrl('/admin/pages/custom/delete') }}" 
