                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="content[500_content][title]" class="form-control" id="title" value="{{ $content['500_content']['title'] ?? '' }}" autocomplete="off">
                                </div>
                                <div class="mb-4">
                                    <label for="text" class="form-label">{{ __('lang.text') }}</label>
                                    <input type="text" name="content[500_content][text]" class="form-control" id="text" value="{{ $content['500_content']['text'] ?? '' }}" autocomplete="off">
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6">
                                    <label for="image" class="form-label">{{ __('lang.image') }}</label>
                                    <input type="file" class="form-control" name="content[500_content][image]" id="image">
                                    @if (isset($content['500_content']['image']))
                                        <div class="img-container d-flex p-3 mt-4">
                                            <div class="covered" style="background: url({{ img('page', $content['500_content']['image']) }});"></div>
                                        </div>
                                    @endif
                                </div>
                            </div>
