                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div>
                                    <textarea 
                                        name="content[content][text]" 
                                        data-upload="{{ LaravelLocalization::localizeUrl("/admin/pages/default/upload-file") }}" 
                                        data-delete="{{ LaravelLocalization::localizeUrl("/admin/pages/default/delete-file") }}" 
                                        class="editor editor-init">{!! $content['content']['text'] ?? '' !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
