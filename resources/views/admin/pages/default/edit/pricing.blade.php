        ...
        <div class="col-md-8 col-lg-9">
            ...
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade" id="v-pills-content" role="tabpanel" aria-labelledby="v-pills-content-tab" tabindex="0">
                    <div class="card">
                        <div class="card-body">
                            <a class="card-heading collapsed pb-3 mb-3" data-bs-toggle="collapse" href="#collapsePlans" role="button" aria-expanded="false" aria-controls="collapsePlans">
                                {{ __('lang.plans') }}
                            </a>
                            <div class="collapse" id="collapsePlans">
                                <div class="row mt-4">
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="plans-upper-title" class="form-label">{{ __('lang.upper_title') }}</label>
                                        <input type="text" name="content[plans][upper_title]" class="form-control" id="plans-upper-title" value="{{ $content['plans']['upper_title'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="plans-title" class="form-label">{{ __('lang.title') }}</label>
                                        <input type="text" name="content[plans][title]" class="form-control" id="plans-title" value="{{ $content['plans']['title'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div>
                                        <label for="plans-text" class="form-label">{{ __('lang.text') }}</label>
                                        <input type="text" name="content[plans][text]" class="form-control" id="plans-text" value="{{ $content['plans']['text'] ?? '' }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
