            ...
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade" id="v-pills-content" role="tabpanel" aria-labelledby="v-pills-content-tab" tabindex="0">
                    <div class="card">
                        <div class="card-body">
                            <a 
                                class="card-heading collapsed pb-3 mb-3" data-bs-toggle="collapse" href="#collapseSearch1" 
                                role="button" aria-expanded="false" aria-controls="collapseSearch1">
                                {{ __('lang.top_area') }}
                            </a>
                            <div class="collapse" id="collapseSearch1">
                                <div class="row mt-4">
                                    <div class="mb-4">
                                        <label for="top-area-title" class="form-label">{{ __('lang.title') }}</label>
                                        <input type="text" name="content[top_area][title]" class="form-control" id="top-area-title" 
                                            value="{{ $content['top_area']['title'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div>
                                        <label for="top-area-text" class="form-label">{{ __('lang.text') }}</label>
                                        <input type="text" name="content[top_area][text]" class="form-control" id="top-area-text" 
                                            value="{{ $content['top_area']['text'] ?? '' }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            <a class="card-heading collapsed pb-3 mb-3" data-bs-toggle="collapse" href="#collapseAbout" role="button" aria-expanded="false" aria-controls="collapseAbout">
                                {{ __('lang.features') }}
                            </a>
                            <div class="collapse" id="collapseAbout">
                                <div class="row mt-4">
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="features-image-1" class="form-label">{{ __('lang.feature_image') }} #1</label>
                                        <input type="file" class="form-control" name="content[features][feature_1_image]" id="features-image-1">
                                        @if (isset($content['features']['feature_1_image']))
                                            <div class="img-container d-flex p-3 mt-4">
                                                <div class="covered" style="background: url({{ img('page', $content['features']['feature_1_image']) }});"></div>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="feature-1-title" class="form-label">{{ __('lang.feature_title') }} #1</label>
                                        <input type="text" name="content[features][feature_1_title]" class="form-control" id="feature-1-title" value="{{ $content['features']['feature_1_title'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div class="mb-4">
                                        <label for="feature-1-text" class="form-label">{{ __('lang.feature_text') }} #1</label>
                                        <input type="text" name="content[features][feature_1_text]" class="form-control" id="feature-1-text" value="{{ $content['features']['feature_1_text'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="features-image-2" class="form-label">{{ __('lang.feature_image') }} #2</label>
                                        <input type="file" class="form-control" name="content[features][feature_2_image]" id="features-image-2">
                                        @if (isset($content['features']['feature_2_image']))
                                            <div class="img-container d-flex p-3 mt-4">
                                                <div class="covered" style="background: url({{ img('page', $content['features']['feature_2_image']) }});"></div>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="feature-2-title" class="form-label">{{ __('lang.feature_title') }} #2</label>
                                        <input type="text" name="content[features][feature_2_title]" class="form-control" id="feature-2-title" value="{{ $content['features']['feature_2_title'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div class="mb-4">
                                        <label for="feature-2-text" class="form-label">{{ __('lang.feature_text') }} #2</label>
                                        <input type="text" name="content[features][feature_2_text]" class="form-control" id="feature-2-text" value="{{ $content['features']['feature_2_text'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="features-image-3" class="form-label">{{ __('lang.feature_image') }} #3</label>
                                        <input type="file" class="form-control" name="content[features][feature_3_image]" id="features-image-3">
                                        @if (isset($content['features']['feature_3_image']))
                                            <div class="img-container d-flex p-3 mt-4">
                                                <div class="covered" style="background: url({{ img('page', $content['features']['feature_3_image']) }});"></div>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6 mb-4">
                                        <label for="feature-3-title" class="form-label">{{ __('lang.feature_title') }} #3</label>
                                        <input type="text" name="content[features][feature_3_title]" class="form-control" id="feature-3-title" value="{{ $content['features']['feature_3_title'] ?? '' }}" autocomplete="off">
                                    </div>
                                    <div>
                                        <label for="feature-3-text" class="form-label">{{ __('lang.feature_text') }} #3</label>
                                        <input type="text" name="content[features][feature_3_text]" class="form-control" id="feature-3-text" value="{{ $content['features']['feature_3_text'] ?? '' }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
